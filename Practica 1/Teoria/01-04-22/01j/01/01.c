...
int main()
{
    ...
    arch=fopen("/Users/tomasprodan/Documents/Programacion Estructurada/Practica 1/Teoria/01-04-22/01j/01/arch.txt","r");     /** Abrir el archivo "arch.txt" de lectura. En arch queda el puntero que refrerencia al archivo*/
